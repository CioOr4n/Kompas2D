...
// BuildPaths.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CBuildPathsApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &CBuildPathsApp::OnAppAbout)
...
// Создание CBuildPathsApp

CBuildPathsApp::CBuildPathsApp() noexcept
{
	...
	SetAppID(_T("BuildPaths.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CBuildPathsApp

CBuildPathsApp theApp;


// Инициализация CBuildPathsApp

BOOL CBuildPathsApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CBuildPathsDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CBuildPathsView));
	if (!pDocTemplate)
		return FALSE;
...
int CBuildPathsApp::ExitInstance()
{
...
// Обработчики сообщений CBuildPathsApp
...
void CBuildPathsApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Методы загрузки или сохранения настроек CBuildPathsApp

void CBuildPathsApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CBuildPathsApp::SaveCustomState()
{
}
